...
a : start motor (bluetooth version) //not used
s : stop motor (bluetooth version) //not used
i : show/hide intensity dots
o : show/hide distance outer line
p : show/hide distance dots
r : show/hide distance rays
j : show/hide RPM label
k : show/hide error count
g : show/hide grid
b : show/hide robot 3D model
l : show/hide lidar 3D model
z : Reset Environment Position"""
...
def read_v_2_4():
    ...
    while True:
        try:
            time.sleep(0.00001) # hog the processor power!
...
while True:
    rate(10) # synchonous repaint at 60fps
    ...
    if scene.kb.keys: # event waiting to be processed?
        ...
        elif s=="l": # Toggle lidar representation
